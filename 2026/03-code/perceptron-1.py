...
X, y = make_blobs(n_samples=1000, centers=2, n_features=2, cluster_std=1.0, random_state=123)
...
perceptron = Perceptron(input_size=input_size, learning_rate=0.0001, epochs=1000)
